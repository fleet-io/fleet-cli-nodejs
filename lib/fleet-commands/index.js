...
let createFleet = async function(appName, region, global, distributedCache, fleetPath, correlationData) {
    ...
    if(distributedCache) {
        fleetConfigData.distributedCache = {
            bucketName: ""
        }
    }
...
let deleteFleet = async function(fleetPath, correlationData) {
    ...
    //Delete distributed cache resources
    if(fleetConfigData.distributedCache) 
        await util.deleteDistributedCache(fleetConfigData, fleetPath);
...
let deployWebsite = async function(websiteName, fleetPath, correlationData) {
    ...
    for(region in fleetConfigData.region) {
        ...
        util.showLog(`Website deployed in ${fleetConfigData.region[region]}!`, fleetPath, correlationData);
        util.showLog(
...
exports.createFleet = async function(appName, region, global, distributedCache, fleetPath, correlationData) {
    if (util.isFleetConfigCreated(fleetPath)) {
        util.showLog(`fleet.json configuration file already exists.`, fleetPath, correlationData);
    } else {
        await util.updateFleetStatus(`creating-fleet`, fleetPath);
        await createFleet.apply(null, arguments).catch(catchCommandPromiseError.bind(this, fleetPath, correlationData));
    }
    
    await util.updateFleetStatus(`ready`, fleetPath);
}

exports.deleteFleet = async function(fleetPath, correlationData) {
    await util.updateFleetStatus(`deleting-fleet`, fleetPath);
...
exports.newRoute = async function(routeName, routeDefinition, routeType, fleetPath, correlationData) {
    await util.updateFleetStatus(`new-route`, fleetPath, routeName);
...
exports.runRoute = async function(routeName, fleetPath, correlationData) {
    await util.updateFleetStatus(`run-route`, fleetPath, routeName);
...
exports.deployRoute = async function(routeName, memorySize, timeout, fleetPath, correlationData) {
    await util.updateFleetStatus(`deploying-route`, fleetPath, routeName);
...
exports.undeployRoute = async function(routeName, fleetPath, correlationData) {
    await util.updateFleetStatus(`undeploying-route`, fleetPath, routeName);
...
exports.deleteRoute = async function(routeName, fleetPath, correlationData) {
    await util.updateFleetStatus(`deleting-route`, fleetPath, routeName);
...
exports.newWebsite = async function(websiteName, fleetPath, correlationData) {
    await util.updateFleetStatus(`new-website`, fleetPath, websiteName);
...
exports.deployWebsite = async function(websiteName, fleetPath, correlationData) {
    await util.updateFleetStatus(`deploy-website`, fleetPath, websiteName);
...
exports.deleteWebsite = async function(websiteName, fleetPath, correlationData) {
    await util.updateFleetStatus(`delete-website`, fleetPath, websiteName);
