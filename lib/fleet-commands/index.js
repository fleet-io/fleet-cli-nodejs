...
exports.createFleet = async function(appName, region, global) {
    ...
    if (util.isFleetConfigCreated()) {
        ...
        if(global) {
            util.showLog(`Retrieving list of available regions for global fleet creation...`);
            region = await awsInterface.describeRegions(fleetConfig);
        }
