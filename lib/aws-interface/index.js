...
let emptyS3Bucket  = async function(fleetConfigData, websiteName, region, fleetPath, correlationData) {
    ...
    util.showLog(`Attempting to delete ${deleteParams.Delete.Objects.length} objects from ${websiteName} in ${region}...`, fleetPath, correlationData);
...
let deleteS3Bucket = async function(fleetConfigData, websiteName, region, fleetPath, correlationData) {
    ...
    await s3.deleteBucket(fleetConfigData, region, params, fleetPath, correlationData)
        .catch(async (e) => 
        {
            ...
            await module.exports.ensureWebsiteUndeployed(fleetConfigData,websiteName,region,fleetPath,correlationData);
        });
}
