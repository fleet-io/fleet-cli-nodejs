...
let apiMethods = {
    ...
    getObject: (fleetConfigData, region, params, fleetPath, correlationData) => {
        return getS3(region).getObject(params).promise().catch(catchPromise.bind(this, 'S3', 'getObject', fleetPath, correlationData));
    },
...
apiExecutor.registerMethod('getObject', apiMethods.getObject);
...
module.exports = {
    ...
    getObject: async function(fleetConfigData, region, params, fleetPath, correlationData) { 
        return await apiExecutor.addCall('getObject', arguments, fleetPath, correlationData).catch(e => {throw e});
    },
