...
module.exports = {
    putObject: async function(fleetConfigData, params, fleetPath, correlationData) { 
        return await apiExecutor.addCall('putObject', arguments, fleetPath).catch(e => {throw e});
    },

    putBucketWebsite: async function(fleetConfigData, params, fleetPath, correlationData) { 
        return await apiExecutor.addCall('putBucketWebsite', arguments, fleetPath).catch(e => {throw e});
    },

    createBucket: async function(fleetConfigData, params, fleetPath, correlationData) { 
        return await apiExecutor.addCall('createBucket', arguments, fleetPath).catch(e => {throw e});
    }
}
