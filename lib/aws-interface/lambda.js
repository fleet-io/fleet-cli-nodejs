...
module.exports = {
    addApigPermission: async function(fleetConfigData, region, params, fleetPath, correlationData) {
        return await apiExecutor.addCall('addApigPermission', arguments, fleetPath).catch(e => {throw e});
    },

    createFunction: async function(fleetConfigData, region, params, fleetPath, correlationData) {
        return await apiExecutor.addCall('createFunction', arguments, fleetPath).catch(e => {throw e});
    },

    deleteFunction: async function(fleetConfigData, region, params, fleetPath, correlationData) {
        return await apiExecutor.addCall('deleteFunction', arguments, fleetPath).catch(e => {throw e});
    },

    updateFunctionCode: async function(fleetConfigData, region, params, fleetPath, correlationData) {
        return await apiExecutor.addCall('updateFunctionCode', arguments, fleetPath).catch(e => {throw e});
    }
}
