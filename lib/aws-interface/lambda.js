...
let apiMethods = {
    ...
    updateFunctionConfiguration: async (fleetConfigData, region, params, fleetPath, correlationData) => {
        if(region) setSvcRegion(region); 
        return getLambda().updateFunctionConfiguration(params).promise().catch(catchPromise.bind(this, 'Lambda', 'updateFunctionConfiguration', fleetPath, correlationData));
    },
}
...
apiExecutor.registerMethod('updateFunctionConfiguration', apiMethods.updateFunctionConfiguration, 0);
...
module.exports = {
    ...
    updateFunctionConfiguration: async function(fleetConfigData, region, params, fleetPath, correlationData) {
        return await apiExecutor.addCall('updateFunctionConfiguration', arguments, fleetPath, correlationData).catch(e => {throw e});
    }
}
