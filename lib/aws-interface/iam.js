...
module.exports = {
    createIAMRole: async function(fleetConfigData, params, fleetPath, correlationData) { 
        return await apiExecutor.addCall('createIAMRole', arguments, fleetPath, correlationData).catch(e => {throw e});
    },

    createIAMPolicy: async function(fleetConfigData, params, fleetPath, correlationData) { 
        return await apiExecutor.addCall('createIAMPolicy', arguments, fleetPath, correlationData).catch(e => {throw e});
    },

    deleteIAMRole: async function(fleetConfigData, params, fleetPath, correlationData) { 
        return await apiExecutor.addCall('deleteIAMRole', arguments, fleetPath, correlationData).catch(e => {throw e});
    },

    deleteIAMRolePolicy: async function(fleetConfigData, params, fleetPath, correlationData) { 
        return await apiExecutor.addCall('deleteIAMRolePolicy', arguments, fleetPath, correlationData).catch(e => {throw e});
    }
}